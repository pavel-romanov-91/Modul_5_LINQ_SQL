    ...
    public partial class Form1 : Form
    {
        ...
        private void btApi_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    MessageBox.Show("Ошибка! Возможно, вы ошиблись при вводе страны. Перепроверьте введённый текст (он должен быть на английском языке)." + " Также может быть, что у вас нет подключения к интернету, либо временно не работает Api.");
                }
            }
